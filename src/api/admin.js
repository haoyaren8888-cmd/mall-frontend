...
export const updateAdminReviewStatus = (id, status) => request.put(`/admin/reviews/${id}/status`, null, { params: { status } })
export const getAdminMessages = params => request.get('/admin/messages', { params })
export const updateAdminMessageStatus = (id, status) => request.put(`/admin/messages/${id}/status`, null, { params: { status } })
