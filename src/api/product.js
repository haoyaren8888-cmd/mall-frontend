...
export const replyProductMessage = (id, messageId, data) => request.put(`/products/${id}/messages/${messageId}/reply`, data)
export const getProductReviews = (id, params) => request.get(`/products/${id}/reviews`, { params })
export const createProductReview = (id, data) => request.post(`/products/${id}/reviews`, data)
